...
type ConnectionRequest struct {
	...
	AskToConnect bool `protobuf:"varint,1,opt,name=askToConnect,proto3" json:"askToConnect,omitempty"`
}
...
func (x *ConnectionRequest) GetAskToConnect() bool {
	if x != nil {
		return x.AskToConnect
	}
	return false
}
...
func (x *Announce) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_announcement_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x37, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x73, 0x6b,
	0x54, 0x6f, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0c, 0x61, 0x73, 0x6b, 0x54, 0x6f, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x22, 0x24, 0x0a,
	0x08, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73,
...
var file_announcement_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_announcement_proto_goTypes = []interface{}{
	(*ConnectionRequest)(nil), // 0: ConnectionRequest
	(*Announce)(nil),          // 1: Announce
}
